    ...
    async def assess(
        ...
        *,
        ...
        prompt = (
            ...
            "Unless the transcript already contains both the relevant application form details and "
            "the Discord invitation itself, set `clear` false and ask for them in the form format. "
